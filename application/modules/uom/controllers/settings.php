...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('UOM.Settings.View');
	...
	{
		$this->auth->restrict('UOM.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_uom())
			{
				...
				redirect(SITE_AREA .'/settings/uom');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('UOM.Settings.Edit');
		...
		{
			$this->auth->restrict('UOM.Settings.Delete');
