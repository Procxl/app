...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('UOM.Developer.View');
	...
	{
		$this->auth->restrict('UOM.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_uom())
			{
				...
				redirect(SITE_AREA .'/developer/uom');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('UOM.Developer.Edit');
		...
		{
			$this->auth->restrict('UOM.Developer.Delete');
