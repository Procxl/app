...
$num_columns	= 13;
$can_delete	= $this->auth->has_permission('Containers.Developer.Delete');
$can_edit		= $this->auth->has_permission('Containers.Developer.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/developer/containers/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->po_ref); ?></td>
				<?php else : ?>
					<td><?php e($record->po_ref); ?></td>
				<?php endif; ?>
					<td><?php e($record->container_no) ?></td>
					<td><?php e($record->seal) ?></td>
					<td><?php e($record->origin) ?></td>
