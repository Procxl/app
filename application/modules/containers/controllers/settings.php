...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Containers.Settings.View');
	...
	{
		$this->auth->restrict('Containers.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_containers())
			{
				...
				redirect(SITE_AREA .'/settings/containers');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Containers.Settings.Edit');
		...
		{
			$this->auth->restrict('Containers.Settings.Delete');
