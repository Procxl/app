...
class reports extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Containers.Reports.View');
	...
	{
		$this->auth->restrict('Containers.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_containers())
			{
				...
				redirect(SITE_AREA .'/reports/containers');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Containers.Reports.Edit');
		...
		{
			$this->auth->restrict('Containers.Reports.Delete');
