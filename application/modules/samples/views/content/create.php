		...
		<fieldset>
			...
			<?php // Change the values in this array to populate your dropdown as required
				if (is_array($vendors_select) && count($vendors_select)) :
					echo form_dropdown('samples_vendor_id', $vendors_select, set_value('samples_vendor_id', isset($samples['vendor_id']) ? $samples['vendor_id'] : ''), 'Vendor' . lang('bf_form_label_required'));
				endif;
			?>
