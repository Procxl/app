...
$num_columns	= 9;
$can_delete	= $this->auth->has_permission('Samples.Settings.Delete');
$can_edit		= $this->auth->has_permission('Samples.Settings.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/settings/samples/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->product_id); ?></td>
				<?php else : ?>
