...
class reports extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Samples.Reports.View');
	...
	{
		$this->auth->restrict('Samples.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_samples())
			{
				...
				redirect(SITE_AREA .'/reports/samples');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Samples.Reports.Edit');
		...
		{
			$this->auth->restrict('Samples.Reports.Delete');
