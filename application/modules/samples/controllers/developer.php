...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Samples.Developer.View');
	...
	{
		$this->auth->restrict('Samples.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_samples())
			{
				...
				redirect(SITE_AREA .'/developer/samples');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Samples.Developer.Edit');
		...
		{
			$this->auth->restrict('Samples.Developer.Delete');
