...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Purchase_Order_Documents.Settings.View');
	...
	{
		$this->auth->restrict('Purchase_Order_Documents.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_purchase_order_documents())
			{
				...
				redirect(SITE_AREA .'/settings/purchase_order_documents');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Purchase_Order_Documents.Settings.Edit');
		...
		{
			$this->auth->restrict('Purchase_Order_Documents.Settings.Delete');
