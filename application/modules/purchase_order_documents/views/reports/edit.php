	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="form-actions">
				...
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/reports/purchase_order_documents', lang('purchase_order_documents_cancel'), 'class="btn btn-warning"'); ?>
				
			<?php if ($this->auth->has_permission('Purchase_Order_Documents.Reports.Delete')) : ?>
				or
