...
$num_columns	= 7;
$can_delete	= $this->auth->has_permission('Purchase_Order_Documents.Developer.Delete');
$can_edit		= $this->auth->has_permission('Purchase_Order_Documents.Developer.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/developer/purchase_order_documents/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->doc_type); ?></td>
				<?php else : ?>
					<td><?php e($record->doc_type); ?></td>
				<?php endif; ?>
					<td><?php e($record->po_ref) ?></td>
					<td><?php e($record->attachments) ?></td>
