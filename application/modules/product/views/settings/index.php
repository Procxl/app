...
$num_columns	= 7;
$can_delete	= $this->auth->has_permission('Product.Settings.Delete');
$can_edit		= $this->auth->has_permission('Product.Settings.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/settings/product/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->name); ?></td>
				<?php else : ?>
