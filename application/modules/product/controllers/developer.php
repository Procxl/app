...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Product.Developer.View');
	...
	{
		$this->auth->restrict('Product.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_product())
			{
				...
				redirect(SITE_AREA .'/developer/product');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Product.Developer.Edit');
		...
		{
			$this->auth->restrict('Product.Developer.Delete');
