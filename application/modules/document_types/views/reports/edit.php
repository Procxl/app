	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="form-actions">
				...
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/reports/document_types', lang('document_types_cancel'), 'class="btn btn-warning"'); ?>
				
			<?php if ($this->auth->has_permission('Document_Types.Reports.Delete')) : ?>
				or
