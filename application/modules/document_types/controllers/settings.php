...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Document_Types.Settings.View');
	...
	{
		$this->auth->restrict('Document_Types.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_document_types())
			{
				...
				redirect(SITE_AREA .'/settings/document_types');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Document_Types.Settings.Edit');
		...
		{
			$this->auth->restrict('Document_Types.Settings.Delete');
