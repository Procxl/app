...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Document_Types.Developer.View');
	...
	{
		$this->auth->restrict('Document_Types.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_document_types())
			{
				...
				redirect(SITE_AREA .'/developer/document_types');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Document_Types.Developer.Edit');
		...
		{
			$this->auth->restrict('Document_Types.Developer.Delete');
