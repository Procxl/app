...
$num_columns	= 14;
$can_delete	= $this->auth->has_permission('Customers.Reports.Delete');
$can_edit		= $this->auth->has_permission('Customers.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/customers/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->name); ?></td>
				<?php else : ?>
