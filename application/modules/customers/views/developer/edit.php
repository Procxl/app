	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<?php // Change the values in this array to populate your dropdown as required
				...
				echo form_dropdown('customers_country', $options, set_value('customers_country', isset($customers['country']) ? $customers['country'] : ''), 'Country');
			?>
			...
			<div class="form-actions">
				...
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/developer/customers', lang('customers_cancel'), 'class="btn btn-warning"'); ?>
				
			<?php if ($this->auth->has_permission('Customers.Developer.Delete')) : ?>
				or
