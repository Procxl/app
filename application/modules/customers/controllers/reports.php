...
class reports extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Customers.Reports.View');
	...
	{
		$this->auth->restrict('Customers.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_customers())
			{
				...
				redirect(SITE_AREA .'/reports/customers');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Customers.Reports.Edit');
		...
		{
			$this->auth->restrict('Customers.Reports.Delete');
