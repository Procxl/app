...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Customers.Developer.View');
	...
	{
		$this->auth->restrict('Customers.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_customers())
			{
				...
				redirect(SITE_AREA .'/developer/customers');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Customers.Developer.Edit');
		...
		{
			$this->auth->restrict('Customers.Developer.Delete');
