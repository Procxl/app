...
class Migration_Install_purchase_orders_permissions extends Migration
{
	...
	private $permission_values = array(
		...
		array(
			'name' => 'Purchase_Orders.Reports.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Purchase_Orders.Reports.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Purchase_Orders.Reports.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Purchase_Orders.Reports.Delete',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Purchase_Orders.Settings.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Purchase_Orders.Settings.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Purchase_Orders.Settings.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Purchase_Orders.Settings.Delete',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Purchase_Orders.Developer.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Purchase_Orders.Developer.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Purchase_Orders.Developer.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Purchase_Orders.Developer.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
