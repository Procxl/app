...
$num_columns	= 12;
$can_delete	= $this->auth->has_permission('Purchase_Orders.Reports.Delete');
$can_edit		= $this->auth->has_permission('Purchase_Orders.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/purchase_orders/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->po_num); ?></td>
				<?php else : ?>
