	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="form-actions">
				...
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/developer/purchase_orders', lang('purchase_orders_cancel'), 'class="btn btn-warning"'); ?>
				
			<?php if ($this->auth->has_permission('Purchase_Orders.Developer.Delete')) : ?>
				or
