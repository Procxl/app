...
class reports extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Purchase_Orders.Reports.View');
	...
	{
		$this->auth->restrict('Purchase_Orders.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_purchase_orders())
			{
				...
				redirect(SITE_AREA .'/reports/purchase_orders');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Purchase_Orders.Reports.Edit');
		...
		{
			$this->auth->restrict('Purchase_Orders.Reports.Delete');
