...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Purchase_Orders.Settings.View');
	...
	{
		$this->auth->restrict('Purchase_Orders.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_purchase_orders())
			{
				...
				redirect(SITE_AREA .'/settings/purchase_orders');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Purchase_Orders.Settings.Edit');
		...
		{
			$this->auth->restrict('Purchase_Orders.Settings.Delete');
