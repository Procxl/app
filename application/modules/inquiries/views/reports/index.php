...
$num_columns	= 11;
$can_delete	= $this->auth->has_permission('Inquiries.Reports.Delete');
$can_edit		= $this->auth->has_permission('Inquiries.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/inquiries/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->product); ?></td>
				<?php else : ?>
