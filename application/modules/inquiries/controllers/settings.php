...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Inquiries.Settings.View');
	...
	{
		$this->auth->restrict('Inquiries.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_inquiries())
			{
				...
				redirect(SITE_AREA .'/settings/inquiries');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Inquiries.Settings.Edit');
		...
		{
			$this->auth->restrict('Inquiries.Settings.Delete');
