...
class reports extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Inquiries.Reports.View');
	...
	{
		$this->auth->restrict('Inquiries.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_inquiries())
			{
				...
				redirect(SITE_AREA .'/reports/inquiries');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Inquiries.Reports.Edit');
		...
		{
			$this->auth->restrict('Inquiries.Reports.Delete');
