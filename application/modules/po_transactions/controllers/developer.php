...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('PO_Transactions.Developer.View');
	...
	{
		$this->auth->restrict('PO_Transactions.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_po_transactions())
			{
				...
				redirect(SITE_AREA .'/developer/po_transactions');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('PO_Transactions.Developer.Edit');
		...
		{
			$this->auth->restrict('PO_Transactions.Developer.Delete');
