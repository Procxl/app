...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('PO_Transactions.Settings.View');
	...
	{
		$this->auth->restrict('PO_Transactions.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_po_transactions())
			{
				...
				redirect(SITE_AREA .'/settings/po_transactions');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('PO_Transactions.Settings.Edit');
		...
		{
			$this->auth->restrict('PO_Transactions.Settings.Delete');
