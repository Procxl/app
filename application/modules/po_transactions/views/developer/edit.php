	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<?php // Change the values in this array to populate your dropdown as required
				...
				echo form_dropdown('po_transactions_po_ref', $options, set_value('po_transactions_po_ref', isset($po_transactions['po_ref']) ? $po_transactions['po_ref'] : ''), 'PO Ref'. lang('bf_form_label_required'));
			?>
			...
			<?php // Change the values in this array to populate your dropdown as required
				...
				echo form_dropdown('po_transactions_trans_type', $options, set_value('po_transactions_trans_type', isset($po_transactions['trans_type']) ? $po_transactions['trans_type'] : ''), 'Transaction Type'. lang('bf_form_label_required'));
			?>
			...
			<?php // Change the values in this array to populate your dropdown as required
				...
				echo form_dropdown('po_transactions_vendor_id', $options, set_value('po_transactions_vendor_id', isset($po_transactions['vendor_id']) ? $po_transactions['vendor_id'] : ''), 'Vendor');
			?>

			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('po_transactions_action_edit'); ?>"  />
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/developer/po_transactions', lang('po_transactions_cancel'), 'class="btn btn-warning"'); ?>
				
			<?php if ($this->auth->has_permission('PO_Transactions.Developer.Delete')) : ?>
				or
