...
$num_columns	= 10;
$can_delete	= $this->auth->has_permission('PO_Transactions.Settings.Delete');
$can_edit		= $this->auth->has_permission('PO_Transactions.Settings.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/settings/po_transactions/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->po_ref); ?></td>
				<?php else : ?>
