	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="form-actions">
				...
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/settings/po_transactions', lang('po_transactions_cancel'), 'class="btn btn-warning"'); ?>
				
			<?php if ($this->auth->has_permission('PO_Transactions.Settings.Delete')) : ?>
				or
